...
const SpellGotatsu = require('app/sdk/spells/spellGotatsu');
const SpellRefreshFriendlyRanged = require('app/sdk/spells/spellRefreshFriendlyRanged');
const SpellTeleportGeneralBehindEnemy = require('app/sdk/spells/spellTeleportGeneralBehindEnemy');
const SpellZodiacTriad = require('app/sdk/spells/spellZodiacTriad');
const SpellFirestormOfAgony = require('app/sdk/spells/spellFirestormOfAgony');
const SpellSpiralCounter = require('app/sdk/spells/spellSpiralCounter');

const Modifier = require('app/sdk/modifiers/modifier');
const ModifierEndTurnWatchTransformNearbyEnemies = require('app/sdk/modifiers/modifierEndTurnWatchTransformNearbyEnemies');
const ModifierBackstabWatchStealSpellFromDeck = require('app/sdk/modifiers/modifierBackstabWatchStealSpellFromDeck');
...
const ModifierSentinelOpponentSummonDamageIt = require('app/sdk/modifiers/modifierSentinelOpponentSummonDamageIt');
...
const ModifierMyMoveWatchAnyReasonDamageNearbyEnemyMinions = require('app/sdk/modifiers/modifierMyMoveWatchAnyReasonDamageNearbyEnemyMinions');
