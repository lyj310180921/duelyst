...
const ModifierOpeningGambitSpawnEnemyMinionNearOpponent = require('app/sdk/modifiers/modifierOpeningGambitSpawnEnemyMinionNearOpponent');
const ModifierFlying = require('app/sdk/modifiers/modifierFlying');
const ModifierEnemySpellWatchCopySpell = require('app/sdk/modifiers/modifierEnemySpellWatchCopySpell');
const ModifierOpeningGambitPutCardInHand = require('app/sdk/modifiers/modifierOpeningGambitPutCardInHand');
const ModifierImmuneToAttacks = require('app/sdk/modifiers/modifierImmuneToAttacks');
const ModifierOpeningGambitRemoveArtifactToDrawArtifactFromFaction = require('app/sdk/modifiers/modifierOpeningGambitRemoveArtifactToDrawArtifactFromFaction');
const ModifierFrenzy = require('app/sdk/modifiers/modifierFrenzy');
const ModifierWildTahr = require('app/sdk/modifiers/modifierWildTahr');
const ModifierCannotCastSpellsByCost = require('app/sdk/modifiers/modifierCannotCastSpellsByCost');
const ModifierKillWatchBounceEnemyToActionBar = require('app/sdk/modifiers/modifierKillWatchBounceEnemyToActionBar');
const ModifierRanged = require('app/sdk/modifiers/modifierRanged');
const ModifierMyGeneralAttackWatchSpawnEntity = require('app/sdk/modifiers/modifierMyGeneralAttackWatchSpawnEntity');
const ModifierFirstBlood = require('app/sdk/modifiers/modifierFirstBlood');
const ModifierOpeningGambitReplaceHand = require('app/sdk/modifiers/modifierOpeningGambitReplaceHand');
const ModifierDealDamageWatchDamageJoinedEnemies = require('app/sdk/modifiers/modifierDealDamageWatchDamageJoinedEnemies');
const ModifierOpeningGambitSpawnPartyAnimals = require('app/sdk/modifiers/modifierOpeningGambitSpawnPartyAnimals');
const ModifierDealDamageWatchIfMinionHealMyGeneral = require('app/sdk/modifiers/modifierDealDamageWatchIfMinionHealMyGeneral');
const ModifierSprigginDiesBuffSelf = require('app/sdk/modifiers/modifierSprigginDiesBuffSelf');
const ModifierSituationalBuffSelfIfSpriggin = require('app/sdk/modifiers/modifierSituationalBuffSelfIfSpriggin');
const ModifierCustomSpawnOnOtherUnit = require('app/sdk/modifiers/modifierCustomSpawnOnOtherUnit');
const ModifierOpeningGambitDagona = require('app/sdk/modifiers/modifierOpeningGambitDagona');
const ModifierDyingWishDagona = require('app/sdk/modifiers/modifierDyingWishDagona');
const ModifierMyAttackWatchGamble = require('app/sdk/modifiers/modifierMyAttackWatchGamble');
