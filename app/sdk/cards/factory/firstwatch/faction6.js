...
const ModifierMyAttackWatchBonusManaCrystal = require('app/sdk/modifiers/modifierMyAttackWatchBonusManaCrystal');
const ModifierDealDamageWatchTeleportEnemyToYourSide = require('app/sdk/modifiers/modifierDealDamageWatchTeleportEnemyToYourSide');
const ModifierSentinelSetup = require('app/sdk/modifiers/modifierSentinelSetup');
const ModifierSentinelOpponentSummonSwapPlaces = require('app/sdk/modifiers/modifierSentinelOpponentSummonSwapPlaces');
...
const ModifierEnemySpellWatchBuffSelf = require('app/sdk/modifiers/modifierEnemySpellWatchBuffSelf');
...
const ModifierImmuneToAttacksByMinions = require('app/sdk/modifiers/modifierImmuneToAttacksByMinions');
...
const SpellDamageCenterColumn = require('app/sdk/spells/spellDamageCenterColumn');
const SpellMightOfVespyr = require('app/sdk/spells/spellMightOfVespyr');
const SpellIllusoryIce = require('app/sdk/spells/spellIllusoryIce');
const SpellAmbush = require('app/sdk/spells/spellAmbush');
...
class CardFactory_FirstWatchSet_Faction6 {
  ...
  static cardForIdentifier(identifier,gameSession) {
    ...
    if (identifier === Cards.Faction6.Shivers) {
      ...
      const gainManaContextObject = ModifierMyAttackWatchBonusManaCrystal.createContextObject();
