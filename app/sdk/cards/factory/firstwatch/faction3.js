...
const SpellSpawnTilesInCenterColumn = require('app/sdk/spells/spellSpawnTilesInCenterColumn');
const SpellBounceToActionbarApplyModifiers = require('app/sdk/spells/spellBounceToActionBarApplyModifiers');
const SpellApplyPlayerModifiers = require('app/sdk/spells/spellApplyPlayerModifiers');
const SpellMirage = require('app/sdk/spells/spellMirage');
const SpellDropLift = require('app/sdk/spells/spellDropLift');

const Modifier = require('app/sdk/modifiers/modifier');
const ModifierOpponentDrawCardWatchGainKeyword = require('app/sdk/modifiers/modifierOpponentDrawCardWatchGainKeyword');
const ModifierStartTurnWatchSummonDervish = require('app/sdk/modifiers/modifierStartTurnWatchSummonDervish');
const ModifierStartTurnWatchDamageEnemiesInRow = require('app/sdk/modifiers/modifierStartTurnWatchDamageEnemiesInRow');
const ModifierPortal = require('app/sdk/modifiers/modifierPortal');
const ModifierStartTurnWatchDestroySelfAndEnemies = require('app/sdk/modifiers/modifierStartTurnWatchDestroySelfAndEnemies');
...
const ModifierDyingWishDrawWishCard = require('app/sdk/modifiers/modifierDyingWishDrawWishCard');
...
const ModifierKillWatchSpawnEntity = require('app/sdk/modifiers/modifierKillWatchSpawnEntity');
