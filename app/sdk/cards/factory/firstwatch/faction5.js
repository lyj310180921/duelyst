...
const SpellToothAndTrial = require('app/sdk/spells/spellToothAndTrial');
const SpellVaathsSpirit = require('app/sdk/spells/spellVaathsSpirit');
const SpellSpawnEntity = require('app/sdk/spells/spellSpawnEntity');
const SpellDinoParty = require('app/sdk/spells/spellDinoParty');
const SpellMassMojo = require('app/sdk/spells/spellMassMojo');
const SpellBloodRage = require('app/sdk/spells/spellBloodRage');

const ModifierOpponentSummonWatchSummonEgg = require('app/sdk/modifiers/modifierOpponentSummonWatchSummonEgg');
...
const ModifierSpellWatchDamageAllMinions = require('app/sdk/modifiers/modifierSpellWatchDamageAllMinions');
