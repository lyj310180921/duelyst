...
const SpellEnslave = require('app/sdk/spells/spellEnslave');
const SpellStarsFury = require('app/sdk/spells/spellStarsFury');
const SpellRashasCurse = require('app/sdk/spells/spellRashasCurse');
const SpellRashasCurseFollowup = require('app/sdk/spells/spellRashasCurseFollowup');
const SpellAurorasTears = require('app/sdk/spells/spellAurorasTears');
let SpellTimeMaelstrom = require('app/sdk/spells/spellTimeMaelstrom');
const SpellBoneSwarm = require('app/sdk/spells/spellBoneSwarm');
const SpellFountainOfYouth = require('app/sdk/spells/spellFountainOfYouth');
SpellTimeMaelstrom = require('app/sdk/spells/spellTimeMaelstrom');
const SpellWindShroud = require('app/sdk/spells/spellWindShroud');
...
const ModifierBlastAttackStrong = require('app/sdk/modifiers/modifierBlastAttackStrong');
const ModifierDyingWishDamageEnemyGeneralHealGeneral = require('app/sdk/modifiers/modifierDyingWishDamageEnemyGeneralHealGeneral');
const ModifierOpeningGambitRefreshArtifacts = require('app/sdk/modifiers/modifierOpeningGambitRefreshArtifacts');
const ModifierDealDamageWatchModifyTarget = require('app/sdk/modifiers/modifierDealDamageWatchModifyTarget');
const ModifierStartTurnWatchSummonDervish = require('app/sdk/modifiers/modifierStartTurnWatchSummonDervish');
...
const ModifierSummonWatchBuffSelf = require('app/sdk/modifiers/modifierSummonWatchBuffSelf');
const ModifierDyingWishEquipArtifactFromDeck = require('app/sdk/modifiers/modifierDyingWishEquipArtifactFromDeck');
...
class CardFactory_CoreSet_Faction3 {
  ...
  static cardForIdentifier(identifier,gameSession) {
    let attackBuff, buffContextObject, customContextObject, statBuff;
    let card = null;
