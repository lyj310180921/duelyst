...
const SpellSwapStats = require('app/sdk/spells/spellSwapStats');
const SpellChromaticCold = require('app/sdk/spells/spellChromaticCold');
const SpellStunAndDamage = require('app/sdk/spells/spellStunAndDamage');
const SpellPermafrostShield = require('app/sdk/spells/spellPermafrostShield');
const SpellAvalanche = require('app/sdk/spells/spellAvalanche');
const SpellAspectBase = require('app/sdk/spells/spellAspectBase');
const SpellAspectOfTheDrake = require('app/sdk/spells/spellAspectOfTheDrake');
const SpellAspectOfTheMountains = require('app/sdk/spells/spellAspectOfTheMountains');
const SpellBounceToActionbar = require('app/sdk/spells/spellBounceToActionbar');
const SpellSpiritAnimalBlessing = require('app/sdk/spells/spellSpiritAnimalBlessing');
const SpellCryogenesis = require('app/sdk/spells/spellCryogenesis');
const SpellApplyModifiersToUnitsInHand = require('app/sdk/spells/spellApplyModifiersToUnitsInHand');
const SpellWarbird = require('app/sdk/spells/spellWarbird');
const SpellKineticSurge = require('app/sdk/spells/spellKineticSurge');
...
const ModifierOpeningGambitApplyModifiers = require('app/sdk/modifiers/modifierOpeningGambitApplyModifiers');
...
const ModifierSummonWatchByRaceBuffSelf = require('app/sdk/modifiers/modifierSummonWatchByRaceBuffSelf');
const ModifierSummonWatchByRaceDamageEnemyMinion = require('app/sdk/modifiers/modifierSummonWatchByRaceDamageEnemyMinion');
const ModifierEndTurnWatchDamageNearbyEnemy = require('app/sdk/modifiers/modifierEndTurnWatchDamageNearbyEnemy');
const ModifierStunWhenAttacked = require('app/sdk/modifiers/modifierStunWhenAttacked');
...
const ModifierSummonWatchFromActionBarSpawnEntity = require('app/sdk/modifiers/modifierSummonWatchFromActionBarSpawnEntity');
const ModifierDyingWishPutCardInHandClean = require('app/sdk/modifiers/modifierDyingWishPutCardInHandClean');
...
class CardFactory_CoreSet_Faction6 {
  ...
  static cardForIdentifier(identifier,gameSession) {
    let attackBuff, attackBuffContextObject, customContextObject, statContextObject;
    let card = null;
