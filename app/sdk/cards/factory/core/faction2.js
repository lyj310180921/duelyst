...
const SpellTwinStrike = require('app/sdk/spells/spellTwinStrike');
const SpellRemoveAndReplaceEntity = require('app/sdk/spells/spellRemoveAndReplaceEntity');
const SpellMartyrdom = require('app/sdk/spells/spellMartyrdom');
const SpellRemoveArtifacts = require('app/sdk/spells/spellRemoveArtifacts');
const SpellApplyPlayerModifiers = require('app/sdk/spells/spellApplyPlayerModifiers');
const SpellHeavensEclipse = require('app/sdk/spells/spellHeavensEclipse');
const SpellInnerFocus = require('app/sdk/spells/spellInnerFocus');
const SpellMistWalking = require('app/sdk/spells/spellMistWalking');
const SpellKillingEdge = require('app/sdk/spells/spellKillingEdge');
const SpellJuxtaposition = require('app/sdk/spells/spellJuxtaposition');
const SpellSpawnEntityNearbyGeneral = require('app/sdk/spells/spellSpawnEntityNearbyGeneral');
const SpellAncestralDivination = require('app/sdk/spells/spellAncestralDivination');
const SpellSwordsBBS = require('app/sdk/spells/spellSwordsBBS');
const SpellApplyModifiersToGeneral = require('app/sdk/spells/spellApplyModifiersToGeneral');
const SpellDrawCardEndOfTurn = require('app/sdk/spells/spellDrawCardEndOfTurn');
...
const ModifierSpellWatchDamageGeneral = require('app/sdk/modifiers/modifierSpellWatchDamageGeneral');
...
const ModifierMyAttackWatchBuffSelf = require('app/sdk/modifiers/modifierMyAttackWatchBuffSelf');
const ModifierDealDamageWatchKillTarget = require('app/sdk/modifiers/modifierDealDamageWatchKillTarget');
const ModifierSpellWatchBloodLeech = require('app/sdk/modifiers/modifierSpellWatchBloodLeech');
const ModifierOpeningGambitApplyPlayerModifiers = require('app/sdk/modifiers/modifierOpeningGambitApplyPlayerModifiers');
const ModifierStartTurnWatchBounceToActionBar = require('app/sdk/modifiers/modifierStartTurnWatchBounceToActionBar');
const ModifierTakeDamageWatchDamageEnemy = require('app/sdk/modifiers/modifierTakeDamageWatchDamageEnemy');
const ModifierSpellDamageWatchPutCardInHand = require('app/sdk/modifiers/modifierSpellDamageWatchPutCardInHand');
const ModifierTakeDamageWatchPutCardInHand = require('app/sdk/modifiers/modifierTakeDamageWatchPutCardInHand');
...
class CardFactory_CoreSet_Faction2 {
  ...
  static cardForIdentifier(identifier,gameSession) {
    ...
    if (identifier === Cards.Spell.SpellSword2) {
      ...
      const movementModifierContextObject = Modifier.createContextObjectOnBoard();
    ...
    if (identifier === Cards.Spell.KillingEdge) {
      ...
      card.spellFilterType = SpellFilterType.AllyDirect;
      const attackBuff = Modifier.createContextObjectWithAttributeBuffs(4,2);
