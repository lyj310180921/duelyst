...
const SpellNetherSummoning = require('app/sdk/spells/spellNetherSummoning');
const SpellChokingShadows = require('app/sdk/spells/spellChokingShadows');
const SpellVoidPulse = require('app/sdk/spells/spellVoidPulse');
const SpellDarkSacrifice = require('app/sdk/spells/spellDarkSacrifice');
const SpellKillTargetSpawnEntity = require('app/sdk/spells/spellKillTargetSpawnEntity');
const SpellSpawnEntity = require('app/sdk/spells/spellSpawnEntity');
const SpellBreathOfTheUnborn = require('app/sdk/spells/spellBreathOfTheUnborn');
const SpellRiteOfTheUndervault = require('app/sdk/spells/spellRiteOfTheUndervault');
const SpellDarkSeed = require('app/sdk/spells/spellDarkSeed');
const SpellConsumingRebirth = require('app/sdk/spells/spellConsumingRebirth');
const SpellShadowspawn = require('app/sdk/spells/spellShadowspawn');
const SpellAbyssalScar = require('app/sdk/spells/spellAbyssalScar');
const SpellSacrificeBBS = require('app/sdk/spells/spellSacrificeBBS');
...
const ModifierOpeningGambitSpawnEntity = require('app/sdk/modifiers/modifierOpeningGambitSpawnEntity');
const ModifierDeathWatchSpawnEntity = require('app/sdk/modifiers/modifierDeathWatchSpawnEntity');
const ModifierOpeningGambitSacrificeNearbyBuffSelf = require('app/sdk/modifiers/modifierOpeningGambitSacrificeNearbyBuffSelf');
const ModifierDyingWishSpawnEntityAnywhere = require('app/sdk/modifiers/modifierDyingWishSpawnEntityAnywhere');
const ModifierDamageGeneralOnAttack = require('app/sdk/modifiers/modifierDamageGeneralOnAttack');
...
const ModifierDyingWishSpawnUnitFromOpponentsDeck = require('app/sdk/modifiers/modifierDyingWishSpawnUnitFromOpponentsDeck');
...
const ModifierKillWatchHealSelf = require('app/sdk/modifiers/modifierKillWatchHealSelf');
const ModifierShadowScar = require('app/sdk/modifiers/modifierShadowScar');
const ModifierStackingShadowsBonusDamage = require('app/sdk/modifiers/modifierStackingShadowsBonusDamage');
...
const ModifierEndTurnWatchSpawnTile = require('app/sdk/modifiers/modifierEndTurnWatchSpawnTile');
...
class CardFactory_CoreSet_Faction4 {
  ...
  static cardForIdentifier(identifier,gameSession) {
    let customContextObject, dyingWishContextObject;
    let card = null;
    ...
    if (identifier === Cards.Faction4.AltGeneral) {
      card = new Unit(gameSession);
      if ((config.get('allCardsAvailable') == null)) {
    ...
    if (identifier === Cards.Faction4.DarkSiren) {
      ...
      const statContextObject = Modifier.createContextObjectWithAttributeBuffs(-2,0);
    ...
    if (identifier === Cards.Spell.ShadowReflection) {
      ...
      card.rarityId = Rarity.Common;
      card.spellFilterType = SpellFilterType.AllyDirect;
      const attackBuff = Modifier.createContextObjectWithAttributeBuffs(5,0);
