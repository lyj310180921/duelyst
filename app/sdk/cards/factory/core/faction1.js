...
const MovementRange = require('app/sdk/entities/movementRange');
...
const SpellBuffAttributeByOtherAttribute = require('app/sdk/spells/spellBuffAttributeByOtherAttribute');
const SpellApplyModifiers = require('app/sdk/spells/spellApplyModifiers');
const SpellHeal = require('app/sdk/spells/spellHeal');
const SpellSilence = require('app/sdk/spells/spellSilence');
const SpellHolyImmolation = require('app/sdk/spells/spellHolyImmolation');
...
const SpellLifeSurge = require('app/sdk/spells/spellLifeSurge');
const SpellDecimate = require('app/sdk/spells/spellDecimate');
const SpellKneel = require('app/sdk/spells/spellKneel');
const SpellSpawnEntityInFrontOfGeneral = require('app/sdk/spells/spellSpawnEntityInFrontOfGeneral');
...
const ModifierBandingAttack = require('app/sdk/modifiers/modifierBandingAttack');
const ModifierBandingHeal = require('app/sdk/modifiers/modifierBandingHeal');
...
const ModifierDispelOnAttack = require('app/sdk/modifiers/modifierDispelOnAttack');
...
const ModifierHealWatchDamageNearbyEnemies = require('app/sdk/modifiers/modifierHealWatchDamageNearbyEnemies');
const ModifierBandingProvoke = require('app/sdk/modifiers/modifierBandingProvoke');
...
class CardFactory_CoreSet_Faction1 {
  ...
  static cardForIdentifier(identifier,gameSession) {
    ...
    if (identifier === Cards.Faction1.ArclyteSentinel) {
      ...
      const followUpAttackBuff = 2;
      const followUpMaxHPBuff = -2;
      const followupModifierContextObject = Modifier.createContextObjectWithAttributeBuffs(followUpAttackBuff,followUpMaxHPBuff);
    ...
    if (identifier === Cards.Faction1.GrandmasterZir) {
      ...
      const contextObject = ModifierBackupGeneral.createContextObject();
    ...
    if (identifier === Cards.Spell.AurynNexus) {
      ...
      card.rarityId = Rarity.Common;
      card.spellFilterType = SpellFilterType.AllyDirect;
      const healthBuff = Modifier.createContextObjectWithAttributeBuffs(0,3);
    ...
    if (identifier === Cards.Spell.LastingJudgement) {
      ...
      card.manaCost = 2;
      card.rarityId = Rarity.Rare;
      const statModifierContextObject = Modifier.createContextObjectWithAttributeBuffs(3,-3);
    ...
    if (identifier === Cards.Spell.AerialRift) {
      ...
      const customContextObject = PlayerModiferCanSummonAnywhere.createContextObject();
    ...
    if (identifier === Cards.Artifact.IndomitableWill) {
      ...
      card.rarityId = Rarity.Epic;
      card.durability = 3;
      const attackBuffContextObject = Modifier.createContextObjectWithAttributeBuffs(2,0);
