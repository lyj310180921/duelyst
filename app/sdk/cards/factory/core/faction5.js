...
const SpellLavastorm = require('app/sdk/spells/spellLavastorm');
const SpellChrysalisBloom = require('app/sdk/spells/spellChrysalisBloom');
const SpellNaturalSelection = require('app/sdk/spells/spellNaturalSelection');
const SpellHealYourGeneral = require('app/sdk/spells/spellHealYourGeneral');
const SpellApplyModifiersToDamagedMinion = require('app/sdk/spells/spellApplyModifiersToDamagedMinion');
const SpellMindSteal = require('app/sdk/spells/spellMindSteal');
const SpellEggMorph = require('app/sdk/spells/spellEggMorph');
const SpellDamageAndApplyModifiers = require('app/sdk/spells/spellDamageAndApplyModifiers');
const SpellTempTransform = require('app/sdk/spells/spellTempTransform');
const SpellSeekingEye = require('app/sdk/spells/spellSeekingEye');
...
const ModifierOpeningGambitDamageMyGeneral = require('app/sdk/modifiers/modifierOpeningGambitDamageMyGeneral');
...
const ModifierEndTurnWatchSpawnEgg = require('app/sdk/modifiers/modifierEndTurnWatchSpawnEgg');
const ModifierEndTurnWatchDamageAllMinions = require('app/sdk/modifiers/modifierEndTurnWatchDamageAllMinions');
...
const ModifierReduceCostOfMinionsAndDamageThem = require('app/sdk/modifiers/modifierReduceCostOfMinionsAndDamageThem');
...
const ModifierOpponentDrawCardWatchBuffSelf = require('app/sdk/modifiers/modifierOpponentDrawCardWatchBuffSelf');
...
class CardFactory_CoreSet_Faction5 {
  ...
  static cardForIdentifier(identifier,gameSession) {
    let attackBuffContextObject, customContextObject, statContextObject;
    let card = null;
