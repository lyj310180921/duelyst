...
const ModifierImmuneToDamageByGeneral = require('app/sdk/modifiers/modifierImmuneToDamageByGeneral');
...
const ModifierOpeningGambitDispel = require('app/sdk/modifiers/modifierOpeningGambitDispel');
...
const ModifierOpeningGambitRetrieveMostRecentSpell = require('app/sdk/modifiers/modifierOpeningGambitRetrieveMostRecentSpell');
const ModifierOpeningGambitRetrieveRandomSpell = require('app/sdk/modifiers/modifierOpeningGambitRetrieveRandomSpell');
...
const ModifierOpeningGambitDamageNearby = require('app/sdk/modifiers/modifierOpeningGambitDamageNearby');
const ModifierStartTurnWatchDamageEnemyGeneralBuffSelf = require('app/sdk/modifiers/modifierStartTurnWatchDamageEnemyGeneralBuffSelf');
const ModifierDyingWishApplyModifiers = require('app/sdk/modifiers/modifierDyingWishApplyModifiers');
const ModifierOpeningGambitDamageBothGenerals = require('app/sdk/modifiers/modifierOpeningGambitDamageBothGenerals');
const ModifierOpeningGambitDamageInFront = require('app/sdk/modifiers/modifierOpeningGambitDamageInFront');
const ModifierOpeningGambitApplyPlayerModifiers = require('app/sdk/modifiers/modifierOpeningGambitApplyPlayerModifiers');
const ModifierOpeningGambitApplyMechazorPlayerModifiers = require('app/sdk/modifiers/modifierOpeningGambitApplyMechazorPlayerModifiers');
const ModifierMyGeneralDamagedWatchBuffSelf = require('app/sdk/modifiers/modifierMyGeneralDamagedWatchBuffSelf');
const ModifierMyGeneralDamagedWatchHealSelf = require('app/sdk/modifiers/modifierMyGeneralDamagedWatchHealSelf');
const ModifierMyGeneralDamagedWatchDamageNearby = require('app/sdk/modifiers/modifierMyGeneralDamagedWatchDamageNearby');
const ModifierDoubleDamageToMinions = require('app/sdk/modifiers/modifierDoubleDamageToMinions');
const ModifierDealDamageWatchHealMyGeneral = require('app/sdk/modifiers/modifierDealDamageWatchHealMyGeneral');
const ModifierOpponentSummonWatchBuffSelf = require('app/sdk/modifiers/modifierOpponentSummonWatchBuffSelf');
const ModifierOpeningGambitDamageNearbyMinions = require('app/sdk/modifiers/modifierOpeningGambitDamageNearbyMinions');
const ModifierOpeningGambitSpawnCopiesOfEntityAnywhere = require('app/sdk/modifiers/modifierOpeningGambitSpawnCopiesOfEntityAnywhere');
const ModifierOpponentSummonWatchDamageEnemyGeneral = require('app/sdk/modifiers/modifierOpponentSummonWatchDamageEnemyGeneral');
const ModifierOpeningGambitDrawArtifactFromDeck = require('app/sdk/modifiers/modifierOpeningGambitDrawArtifactFromDeck');
const ModifierSummonWatchNearbyApplyModifiers = require('app/sdk/modifiers/modifierSummonWatchNearbyApplyModifiers');
const ModifierTakeDamageWatchRandomTeleport = require('app/sdk/modifiers/modifierTakeDamageWatchRandomTeleport');
const ModifierOpeningGambitSpawnEntityInEachCorner = require('app/sdk/modifiers/modifierOpeningGambitSpawnEntityInEachCorner');
const ModifierOpeningGambitMindwarp = require('app/sdk/modifiers/modifierOpeningGambitMindwarp');
const ModifierEndTurnWatchSpawnRandomEntity = require('app/sdk/modifiers/modifierEndTurnWatchSpawnRandomEntity');
const ModifierOpeningGambitRemoveRandomArtifact = require('app/sdk/modifiers/modifierOpeningGambitRemoveRandomArtifact');
const ModifierEndTurnWatchHealNearby = require('app/sdk/modifiers/modifierEndTurnWatchHealNearby');
const ModifierDealDamageWatchTeleportToMe = require('app/sdk/modifiers/modifierDealDamageWatchTeleportToMe');
const ModifierDyingWishSpawnEntityNearbyGeneral = require('app/sdk/modifiers/modifierDyingWishSpawnEntityNearbyGeneral');
const ModifierOpeningGambitBuffSelfByOpponentHandCount = require('app/sdk/modifiers/modifierOpeningGambitBuffSelfByOpponentHandCount');
const ModifierTakeDamageWatchDamageEnemyGeneralForSame = require('app/sdk/modifiers/modifierTakeDamageWatchDamageEnemyGeneralForSame');
const ModifierDealDamageWatchDrawCard = require('app/sdk/modifiers/modifierDealDamageWatchDrawCard');
const ModifierStartTurnWatchSwapStats = require('app/sdk/modifiers/modifierStartTurnWatchSwapStats');
const ModifierHealSelfWhenDealingDamage = require('app/sdk/modifiers/modifierHealSelfWhenDealingDamage');
const ModifierDealDamageWatchHealorDamageGeneral = require('app/sdk/modifiers/modifierDealDamageWatchHealorDamageGeneral');
const ModifierOpeningGambitLifeGive = require('app/sdk/modifiers/modifierOpeningGambitLifeGive');
const ModifierOpeningGambitTeleportAllNearby = require('app/sdk/modifiers/modifierOpeningGambitTeleportAllNearby');
const ModifierRook = require('app/sdk/modifiers/modifierRook');
...
const ModifierOpeningGambitDrawCardBothPlayers = require('app/sdk/modifiers/modifierOpeningGambitDrawCardBothPlayers');
const ModifierSurviveDamageWatchReturnToHand = require('app/sdk/modifiers/modifierSurviveDamageWatchReturnToHand');
const ModifierDoubleDamageToGenerals = require('app/sdk/modifiers/modifierDoubleDamageToGenerals');
const ModifierOpeningGambitHealBothGenerals = require('app/sdk/modifiers/modifierOpeningGambitHealBothGenerals');
...
class CardFactory_CoreSet_Neutral {
  ...
  static cardForIdentifier(identifier,gameSession) {
    let contextObject, customContextObject, statBuffContextObject, statContextObject;
    let card = null;
    ...
    if (identifier === Cards.Neutral.TheHighHand) {
      ...
      const attackBuff = ModifierOpeningGambitBuffSelfByOpponentHandCount.createContextObject(1,1);
