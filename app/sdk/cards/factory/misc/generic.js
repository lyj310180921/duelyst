...
const SpellKillTarget = require('app/sdk/spells/spellKillTarget');
const SpellFollowupTeleport = require('app/sdk/spells/spellFollowupTeleport');
const SpellFollowupTeleportToMe = require('app/sdk/spells/spellFollowupTeleportToMe');
const SpellFollowupTeleportMyGeneral = require('app/sdk/spells/spellFollowupTeleportMyGeneral');
const SpellSilence = require('app/sdk/spells/spellSilence');
const SpellSpawnEntity = require('app/sdk/spells/spellSpawnEntity');
const SpellCloneTargetEntity = require('app/sdk/spells/spellCloneTargetEntity');
const SpellCloneSourceEntity = require('app/sdk/spells/spellCloneSourceEntity');
const SpellKillTargetWithModifierRanged = require('app/sdk/spells/spellKillTargetWithModifierRanged');
const SpellDunecasterFollowup = require('app/sdk/spells/spellDunecasterFollowup');
const SpellFollowupSwapPositions = require('app/sdk/spells/spellFollowupSwapPositions');
const SpellFollowupDamage = require('app/sdk/spells/spellFollowupDamage');
const SpellFollowupHeal = require('app/sdk/spells/spellFollowupHeal');
const SpellMindControlByAttackValue = require('app/sdk/spells/spellMindControlByAttackValue');
const SpellFollowupRandomTeleport = require('app/sdk/spells/spellFollowupRandomTeleport');
const SpellFollowupKeeper = require('app/sdk/spells/spellFollowupKeeper');
const SpellFollowupHollowGroveKeeper = require('app/sdk/spells/spellFollowupHollowGroveKeeper');
const SpellFollowupKillTargetByAttack = require('app/sdk/spells/spellFollowupKillTargetByAttack');
const SpellCloneSourceEntityNearbyGeneral = require('app/sdk/spells/spellCloneSourceEntityNearbyGeneral');
const SpellDoubleAttackAndHealth = require('app/sdk/spells/spellDoubleAttackAndHealth');
const SpellHatchAnEgg = require('app/sdk/spells/spellHatchAnEgg');
const SpellFollowupActivateBattlePet = require('app/sdk/spells/spellFollowupActivateBattlePet');
const SpellSpawnEntityAndApplyPlayerModifiers = require('app/sdk/spells/spellSpawnEntityAndApplyPlayerModifiers');
const SpellFollowupTeleportMyGeneralBehindEnemy = require('app/sdk/spells/spellFollowupTeleportMyGeneralBehindEnemy');
const SpellFollowupTeleportInFrontOfAnyGeneral = require('app/sdk/spells/spellFollowupTeleportInFrontOfAnyGeneral');
const SpellSpawnNeutralEntity = require('app/sdk/spells/spellSpawnNeutralEntity');
const SpellFollowupFight = require('app/sdk/spells/spellFollowupFight');
const SpellOverwatch = require('app/sdk/spells/spellOverwatch');
const SpellBounceToActionBarSpawnEntity = require('app/sdk/spells/spellBounceToActionBarSpawnEntity');
const SpellFollowupTeleportToFriendlyCreep = require('app/sdk/spells/spellFollowupTeleportToFriendlyCreep');
const SpellFollowupTeleportNearMyGeneral = require('app/sdk/spells/spellFollowupTeleportNearMyGeneral');
const SpellBounceToActionbar = require('app/sdk/spells/spellBounceToActionbar');
const SpellDuplicator = require('app/sdk/spells/spellDuplicator');
const SpellApplyPlayerModifiers = require('app/sdk/spells/spellApplyPlayerModifiers');
const SpellFollowupSpawnEntityFromDeck = require('app/sdk/spells/spellFollowupSpawnEntityFromDeck');
const SpellDamageOrHeal = require('app/sdk/spells/spellDamageOrHeal');
