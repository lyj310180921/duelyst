...
const SpellEquipBossArtifacts = require('app/sdk/spells/spellEquipBossArtifacts');
const SpellLaceratingFrost = require('app/sdk/spells/spellLaceratingFrost');
const SpellEntanglingShadows = require('app/sdk/spells/spellEntanglingShadows');
const SpellMoldingEarth = require('app/sdk/spells/spellMoldingEarth');
const SpellDamageAndSpawnEntitiesNearbyGeneral = require('app/sdk/spells/spellDamageAndSpawnEntitiesNearbyGeneral');
const SpellSilenceAndSpawnEntityNearby = require('app/sdk/spells/spellSilenceAndSpawnEntityNearby');
const SpellRestoringLight = require('app/sdk/spells/spellRestoringLight');

const Modifier = require('app/sdk/modifiers/modifier');
const PlayerModifierManaModifier = require('app/sdk/playerModifiers/playerModifierManaModifier');
let ModifierProvoke = require('app/sdk/modifiers/modifierProvoke');
const ModifierEndTurnWatchDamageNearbyEnemy = require('app/sdk/modifiers/modifierEndTurnWatchDamageNearbyEnemy');
...
const ModifierStartTurnWatchEquipArtifact = require('app/sdk/modifiers/modifierStartTurnWatchEquipArtifact');
...
const ModifierStartTurnWatchPlaySpell = require('app/sdk/modifiers/modifierStartTurnWatchPlaySpell');
const ModifierDealDamageWatchModifyTarget = require('app/sdk/modifiers/modifierDealDamageWatchModifyTarget');
...
let ModifierCardControlledPlayerModifiers = require('app/sdk/modifiers/modifierCardControlledPlayerModifiers');
...
const ModifierStartTurnWatchDispelAllEnemyMinionsDrawCard = require('app/sdk/modifiers/modifierStartTurnWatchDispelAllEnemyMinionsDrawCard');
const ModifierImmuneToSpellsByEnemy = require('app/sdk/modifiers/modifierImmuneToSpellsByEnemy');
const ModifierAbsorbDamageGolems = require('app/sdk/modifiers/modifierAbsorbDamageGolems');
const ModifierExpireApplyModifiers = require('app/sdk/modifiers/modifierExpireApplyModifiers');
const ModifierSecondWind = require('app/sdk/modifiers/modifierSecondWind');
const ModifierKillWatchRespawnEntity = require('app/sdk/modifiers/modifierKillWatchRespawnEntity');
const ModifierOpponentSummonWatchSpawn1HealthClone = require('app/sdk/modifiers/modifierOpponentSummonWatchSpawn1HealthClone');
const ModifierDealOrTakeDamageWatchRandomTeleportOther = require('app/sdk/modifiers/modifierDealOrTakeDamageWatchRandomTeleportOther');
...
const ModifierEndTurnWatchTeleportCorner = require('app/sdk/modifiers/modifierEndTurnWatchTeleportCorner');
const ModifierBackstab = require('app/sdk/modifiers/modifierBackstab');
const ModifierDieSpawnNewGeneral = require('app/sdk/modifiers/modifierDieSpawnNewGeneral');
const ModifierKillWatchRefreshExhaustion = require('app/sdk/modifiers/modifierKillWatchRefreshExhaustion');
const ModifierEndTurnWatchDealDamageToSelfAndNearbyEnemies = require('app/sdk/modifiers/modifierEndTurnWatchDealDamageToSelfAndNearbyEnemies');
...
const ModifierHealSelfWhenDealingDamage = require('app/sdk/modifiers/modifierHealSelfWhenDealingDamage');
...
const ModifierDeathWatchDamageEnemyGeneralHealMyGeneral = require('app/sdk/modifiers/modifierDeathWatchDamageEnemyGeneralHealMyGeneral');
...
const ModifierMyTeamMoveWatchBuffTarget = require('app/sdk/modifiers/modifierMyTeamMoveWatchAnyReasonBuffTarget');
...
const ModifierDoubleDamageToGenerals = require('app/sdk/modifiers/modifierDoubleDamageToGenerals');
const ModifierATKThresholdDie = require('app/sdk/modifiers/modifierATKThresholdDie');
const ModifierDeathWatchDamageRandomMinionHealMyGeneral = require('app/sdk/modifiers/modifierDeathWatchDamageRandomMinionHealMyGeneral');
const ModifierStartTurnWatchSpawnTile = require('app/sdk/modifiers/modifierStartTurnWatchSpawnTile');
const ModifierStartTurnWatchSpawnEntity = require('app/sdk/modifiers/modifierStartTurnWatchSpawnEntity');
const ModifierEndTurnWatchGainTempBuff = require('app/sdk/modifiers/modifierEndTurnWatchGainTempBuff');
...
const ModifierSentinelOpponentGeneralAttackHealEnemyGeneralDrawCard = require('app/sdk/modifiers/modifierSentinelOpponentGeneralAttackHealEnemyGeneralDrawCard');
const ModifierSentinelOpponentSummonBuffItDrawCard = require('app/sdk/modifiers/modifierSentinelOpponentSummonBuffItDrawCard');
const ModifierSentinelOpponentSpellCastRefundManaDrawCard = require('app/sdk/modifiers/modifierSentinelOpponentSpellCastRefundManaDrawCard');
const ModifierTakeDamageWatchSpawnRandomHaunt = require('app/sdk/modifiers/modifierTakeDamageWatchSpawnRandomHaunt');
const ModifierDyingWishDrawCard = require("app/sdk/modifiers/modifierDyingWishDrawCard");
const ModifierCannotAttackGeneral = require('app/sdk/modifiers/modifierCannotAttackGeneral');
const ModifierCannotCastBBS = require('app/sdk/modifiers/modifierCannotCastBBS');
const ModifierStartTurnWatchPutCardInOpponentsHand = require('app/sdk/modifiers/modifierStartTurnWatchPutCardInOpponentsHand');
const ModifierEndTurnWatchHealSelf = require('app/sdk/modifiers/modifierEndTurnWatchHealSelf');
const ModifierBackupGeneral = require('app/sdk/modifiers/modifierBackupGeneral');
const ModifierStartTurnWatchRespawnClones = require('app/sdk/modifiers/modifierStartTurnWatchRespawnClones');
ModifierCardControlledPlayerModifiers = require('app/sdk/modifiers/modifierCardControlledPlayerModifiers');
const ModifierSwitchAllegiancesGainAttack = require('app/sdk/modifiers/modifierSwitchAllegiancesGainAttack');
const ModifierOpponentSummonWatchRandomTransform = require('app/sdk/modifiers/modifierOpponentSummonWatchRandomTransform');
const ModifierOnSpawnKillMyGeneral = require('app/sdk/modifiers/modifierOnSpawnKillMyGeneral');
const ModifierDeathWatchGainAttackEqualToEnemyAttack = require('app/sdk/modifiers/modifierDeathWatchGainAttackEqualToEnemyAttack');
const ModifierDyingWishBuffEnemyGeneral = require('app/sdk/modifiers/modifierDyingWishBuffEnemyGeneral');
const ModifierStartTurnWatchDamageRandom = require('app/sdk/modifiers/modifierStartTurnWatchDamageRandom');
const ModifierOpponentSummonWatchSwapGeneral = require('app/sdk/modifiers/modifierOpponentSummonWatchSwapGeneral');
const ModifierDyingWishPutCardInOpponentHand = require('app/sdk/modifiers/modifierDyingWishPutCardInOpponentHand');
const ModifierEnemySpellWatchGainRandomKeyword = require('app/sdk/modifiers/modifierEnemySpellWatchGainRandomKeyword');
const ModifierAnySummonWatchGainGeneralKeywords = require('app/sdk/modifiers/modifierAnySummonWatchGainGeneralKeywords');
...
class CardFactory_Bosses {
  ...
  */
  static cardForIdentifier(identifier,gameSession) {
    let applyGeneralImmunityContextObject, applyModifierToSummonedMinions, backstabObject, backupGeneral, cannotAttackGenerals, celerityObject, contextObject, dyingWishDrawCards, equipArtifactObject, excludedArtifacts, flyingObject, forceFieldObject, frenzyContextObject, healAura, healObject, immuneToSpellTargeting, immunityContextObject, includedArtifacts, increasedManaCost, legion, provokeObject, rangedModifier, respawnClones, rushContextObject, sentinelData, speedBuffContextObject;
    let card = null;
    ...
    if (identifier === Cards.Boss.Boss11) {
      ...
      card.atk = 3;
      card.maxHP = 60;
      const modifierSelfDamageAreaAttack = ModifierSelfDamageAreaAttack.createContextObject();
    ...
    if (identifier === Cards.Boss.Boss15) {
      ...
      card.maxHP = 30;
      card.setDamage(10);
      const gainModifiersOnHPChange = ModifierHPThresholdGainModifiers.createContextObject();
    ...
    if (identifier === Cards.Boss.Boss16) {
      ...
      card.atk = 2;
      card.maxHP = 30;
      const lifestealModifier = ModifierHealSelfWhenDealingDamage.createContextObject();
    ...
    if (identifier === Cards.Boss.Boss24Valiant) {
      ...
      provokeObject = ModifierProvoke.createContextObject();
      provokeObject.isRemovable = false;
      const rangedProvoke = ModifierRangedProvoke.createContextObject();
    ...
    if (identifier === Cards.Boss.Boss26) {
      ...
      card.maxHP = 40;
      card.speed = 0;
      const attacksDamageAllMinions = ModifierAttacksDamageAllEnemyMinions.createContextObject();
    ...
    if (identifier === Cards.Boss.Boss26Companion) {
      ...
      card.maxHP = 20;
      card.speed = 3;
      const dyingWishKillGeneral = ModifierDyingWishLoseGame.createContextObject();
      dyingWishKillGeneral.isRemovable = false;
      const atkLimiter = ModifierATKThresholdDie.createContextObject(6);
    ...
    if (identifier === Cards.Boss.Boss31) {
      ...
      card.atk = 2;
      card.maxHP = 50;
      const takeDamageSpawnHaunt = ModifierTakeDamageWatchSpawnRandomHaunt.createContextObject();
    ...
    if (identifier === Cards.Boss.Boss34_2) {
      ...
      card.atk = 3;
      card.maxHP = 25;
      const swapAllegiancesGainAttack = ModifierSwitchAllegiancesGainAttack.createContextObject();
    ...
    if (identifier === Cards.Boss.Boss36) {
      ...
      card.atk = 3;
      card.maxHP = 80;
      const damageRandom = ModifierStartTurnWatchDamageRandom.createContextObject(6);
    ...
    if (identifier === Cards.Boss.Boss36_2) {
      ...
      card.atk = 1;
      card.maxHP = 50;
      const replaceGeneral = ModifierOnSpawnKillMyGeneral.createContextObject();
      replaceGeneral.isRemovable = false;
      const gainAttackOnKill = ModifierDeathWatchGainAttackEqualToEnemyAttack.createContextObject();
    ...
    if (identifier === Cards.Boss.Boss36_3) {
      ...
      card.atk = 0;
      card.maxHP = 3;
      const buffEnemyGeneralOnDeath = ModifierDyingWishBuffEnemyGeneral.createContextObject(2,6);
    ...
    if (identifier === Cards.Boss.Boss38) {
      ...
      card.atk = 3;
      card.maxHP = 35;
      const spellWatchGainKeyword = ModifierEnemySpellWatchGainRandomKeyword.createContextObject();
      spellWatchGainKeyword.isRemovable = false;
      const summonsGainKeywords = ModifierAnySummonWatchGainGeneralKeywords.createContextObject();
