...
const SpellEggGrenade = require('app/sdk/spells/spellEggGrenade');
const SpellEmbryoticInsight = require('app/sdk/spells/spellEmbryoticInsight');
const SpellUpperHand = require('app/sdk/spells/spellUpperHand');
const SpellSaurianFinality = require('app/sdk/spells/spellSaurianFinality');
const SpellHomeostaticRebuke = require('app/sdk/spells/spellHomeostaticRebuke');
const SpellApplyModifiers = require('app/sdk/spells/spellApplyModifiers');
const SpellEffulgentInfusion = require('app/sdk/spells/spellEffulgentInfusion');

const Modifier = require('app/sdk/modifiers/modifier');
const ModifierOpeningGambitProgenitor = require('app/sdk/modifiers/modifierOpeningGambitProgenitor');
...
const ModifierSummonWatchFromActionBarByRaceBothPlayersDraw = require('app/sdk/modifiers/modifierSummonWatchFromActionBarByRaceBothPlayersDraw');
const ModifierSynergizeDamageClosestEnemy = require('app/sdk/modifiers/modifierSynergizeDamageClosestEnemy');
const ModifierRebirth = require('app/sdk/modifiers/modifierRebirth');
const ModifierMyAttackOrCounterattackWatchTransformIntoEgg = require('app/sdk/modifiers/modifierMyAttackOrCounterattackWatchTransformIntoEgg');
const ModifierKillWatchSpawnEgg = require('app/sdk/modifiers/modifierKillWatchSpawnEgg');
