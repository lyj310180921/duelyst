...
const SpellEssenceSculpt = require('app/sdk/spells/spellEssenceSculpt');
const SpellSpawnEntity = require('app/sdk/spells/spellSpawnEntity');
const SpellKillTargetWithModifierStunned = require('app/sdk/spells/spellKillTargetWithModifierStunned');
const SpellApplyModifiers = require('app/sdk/spells/spellApplyModifiers');
const SpellDoubleAttributeBuffs = require('app/sdk/spells/spellDoubleAttributeBuffs');
...
const ModifierSynergizeRazorArchitect = require('app/sdk/modifiers/modifierSynergizeRazorArchitect');
const ModifierAirdrop = require('app/sdk/modifiers/modifierAirdrop');
const ModifierDoubleDamageToStunnedEnemies = require('app/sdk/modifiers/modifierDoubleDamageToStunnedEnemies');
const ModifierMyAttackOrCounterattackWatchApplyModifiersToFriendlyMinions = require('app/sdk/modifiers/modifierMyAttackOrCounterattackWatchApplyModifiersToFriendlyMinions');
const ModifierDyingWish = require('app/sdk/modifiers/modifierDyingWish');
const ModifierDyingWishRespawnEntity = require('app/sdk/modifiers/modifierDyingWishRespawnEntity');
const ModifierBuildingSlowEnemies = require('app/sdk/modifiers/modifierBuildingSlowEnemies');
...
const ModifierSummonWatchByRaceSummonCopy = require('app/sdk/modifiers/modifierSummonWatchByRaceSummonCopy');
...
class CardFactory_WartechSet_Faction6 {
  ...
  static cardForIdentifier(identifier,gameSession) {
    ...
    if (identifier === Cards.Artifact.AnimusPlate) {
      ...
      card.rarityId = Rarity.Rare;
      card.durability = 3;
      const minionBuff = Modifier.createContextObjectWithAttributeBuffs(2,2);
    ...
    if (identifier === Cards.Spell.Auroraboros) {
      ...
      const customContextObject = ModifierDyingWishRespawnEntity.createContextObject();
