...
const SpellTogetherness = require('app/sdk/spells/spellTogetherness');
const SpellSunstrike = require('app/sdk/spells/spellSunstrike');
const SpellApplyModifiersToUndamagedMinion = require('app/sdk/spells/spellApplyModifiersToUndamagedMinion');
const SpellApplyModifiersToGeneralAndNearbyAllies = require('app/sdk/spells/spellApplyModifiersToGeneralAndNearbyAllies');
...
const ModifierSynergizeSummonMinionNearGeneral = require('app/sdk/modifiers/modifierSynergizeSummonMinionNearGeneral');
...
const ModifierSummonWatchNearbyApplyModifiersToBoth = require('app/sdk/modifiers/modifierSummonWatchNearbyApplyModifiersToBoth');
const ModifierSummonWatchNearbyTransform = require('app/sdk/modifiers/modifierSummonWatchNearbyTransform');
...
const ModifierSituationalBuffSelfIfFullHealth = require('app/sdk/modifiers/modifierSituationalBuffSelfIfFullHealth');
const ModifierBuildCompleteApplyModifiersToNearbyAllies = require('app/sdk/modifiers/modifierBuildCompleteApplyModifiersToNearbyAllies');
const ModifierAuraAboveAndBelow = require('app/sdk/modifiers/modifierAuraAboveAndBelow');
...
class CardFactory_WartechSet_Faction1 {
  ...
  static cardForIdentifier(identifier,gameSession) {
    let buffContextObject, buildData, statContextObject;
    let card = null;
    ...
    if (identifier === Cards.Artifact.SunbondPavise) {
      ...
      card.rarityId = Rarity.Rare;
      card.durability = 3;
      const attackBuffModifier = Modifier.createContextObjectWithAttributeBuffs(2);
