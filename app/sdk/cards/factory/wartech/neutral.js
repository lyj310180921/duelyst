...
const SpellForgeArtifact = require('app/sdk/spells/spellForgeArtifact');
...
const ModifierSynergizeDrawBloodboundSpell = require('app/sdk/modifiers/modifierSynergizeDrawBloodboundSpell');
const ModifierOpeningGambit =     require('app/sdk/modifiers/modifierOpeningGambit');
const ModifierOpeningGambitDrawCopyFromDeck = require('app/sdk/modifiers/modifierOpeningGambitDrawCopyFromDeck');
const ModifierSummonWatchAnywhereByRaceBuffSelf = require('app/sdk/modifiers/modifierSummonWatchAnywhereByRaceBuffSelf');
const ModifierKillWatchDeceptibot = require('app/sdk/modifiers/modifierKillWatchDeceptibot');
...
const ModifierSynergizeBuffSelf = require('app/sdk/modifiers/modifierSynergizeBuffSelf');
const ModifierOpeningGambitRemoveCardsFromDecksByCost = require('app/sdk/modifiers/modifierOpeningGambitRemoveCardsFromDecksByCost');
const ModifierEnemyAttackWatchGainAttack = require('app/sdk/modifiers/modifierEnemyAttackWatchGainAttack');
const ModifierProvoke = require('app/sdk/modifiers/modifierProvoke');
const ModifierDeathWatchFriendlyMinionSwapAllegiance = require('app/sdk/modifiers/modifierDeathWatchFriendlyMinionSwapAllegiance');
...
const ModifierBuildCompleteHealGeneral = require('app/sdk/modifiers/modifierBuildCompleteHealGeneral');
const ModifierMyBuildWatchDrawCards = require('app/sdk/modifiers/modifierMyBuildWatchDrawCards');
const ModifierOpeningGambitProgressBuild = require('app/sdk/modifiers/modifierOpeningGambitProgressBuild');
const ModifierSummonWatchMechsShareKeywords = require('app/sdk/modifiers/modifierSummonWatchMechsShareKeywords');
const ModifierSituationalBuffSelfIfHaveMech = require('app/sdk/modifiers/modifierSituationalBuffSelfIfHaveMech');
...
class CardFactory_WartechSet_Neutral {
  ...
  static cardForIdentifier(identifier,gameSession) {
    ...
    if (identifier === Cards.Neutral.RedsteelMinos) {
      ...
      card.manaCost = 3;
      card.rarityId = Rarity.Common;
      const buffContextObject = Modifier.createContextObjectWithAttributeBuffs(2,2);
