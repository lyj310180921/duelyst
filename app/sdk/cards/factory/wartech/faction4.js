...
const SpellBetrayal = require('app/sdk/spells/spellBetrayal');
const SpellDamageAndApplyModifiers = require('app/sdk/spells/spellDamageAndApplyModifiers');
const SpellVellumscry = require('app/sdk/spells/spellVellumscry');
const SpellAbhorrentUnbirth = require('app/sdk/spells/spellAbhorrentUnbirth');

const Modifier = require('app/sdk/modifiers/modifier');
const ModifierDeathWatch = require('app/sdk/modifiers/modifierDeathWatch');
const ModifierDeathWatchBuffMinionsInHand = require('app/sdk/modifiers/modifierDeathWatchBuffMinionsInHand');
const ModifierDyingWishDestroyRandomEnemyNearby = require('app/sdk/modifiers/modifierDyingWishDestroyRandomEnemyNearby');
...
const ModifierDyingWishAddCardToDeck = require('app/sdk/modifiers/modifierDyingWishAddCardToDeck');
const ModifierOnDyingInfest = require('app/sdk/modifiers/modifierOnDyingInfest');
...
const ModifierEternalHeart = require('app/sdk/modifiers/modifierEternalHeart');
const ModifierDeathWatchSpawnRandomDemon = require('app/sdk/modifiers/modifierDeathWatchSpawnRandomDemon');
const ModifierWhenAttackedDestroyThis = require('app/sdk/modifiers/modifierWhenAttackedDestroyThis');
...
class CardFactory_WartechSet_Faction4 {
  ...
  static cardForIdentifier(identifier,gameSession) {
    ...
    if (identifier === Cards.Faction4.StygianObserver) {
      ...
      const statsBuff = Modifier.createContextObjectWithAttributeBuffs(2,2);
    ...
    if (identifier === Cards.Spell.Deathmark) {
      ...
      const whenAttackedModifier = ModifierWhenAttackedDestroyThis.createContextObject();
    ...
    if (identifier === Cards.Spell.HorrificVisage) {
      ...
      const customContextObject = Modifier.createContextObjectWithAttributeBuffs(-4,0);
