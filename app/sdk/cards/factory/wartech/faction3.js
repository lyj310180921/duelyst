...
const SpellGodMulligan = require('app/sdk/spells/spellGodMulligan');
const SpellSetHealthEqualToAttack = require('app/sdk/spells/spellSetHealthEqualToAttack');
const SpellDamageOwnGeneral = require('app/sdk/spells/spellDamageOwnGeneral');
const SpellLostInTheDesert = require('app/sdk/spells/spellLostInTheDesert');
const SpellNeurolink = require('app/sdk/spells/spellNeurolink');

const Modifier = require('app/sdk/modifiers/modifier');
const ModifierSynergizeSummonMinionNearby = require('app/sdk/modifiers/modifierSynergizeSummonMinionNearby');
...
const ModifierDyingWishDrawEnemyLegendaryArtifact = require('app/sdk/modifiers/modifierDyingWishDrawEnemyLegendaryArtifact');
const ModifierOpeningGambitSniperZen = require('app/sdk/modifiers/modifierOpeningGambitSniperZen');
...
const ModifierBuildCompleteReplicateAndSummonDervish = require('app/sdk/modifiers/modifierBuildCompleteReplicateAndSummonDervish');
const ModifierImmuneToDamage = require('app/sdk/modifiers/modifierImmuneToDamage');
const ModifierStartTurnWatchApplyTempArtifactModifier = require('app/sdk/modifiers/modifierStartTurnWatchApplyTempArtifactModifier');
...
class CardFactory_WartechSet_Faction3 {
  ...
  static cardForIdentifier(identifier,gameSession) {
    ...
    if (identifier === Cards.Artifact.IrisBarrier) {
      ...
      card.rarityId = Rarity.Rare;
      card.durability = 3;
      const damageImmuneModifier = ModifierImmuneToDamage.createContextObject();
      card.setTargetModifiersContextObjects([
