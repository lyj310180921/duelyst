...
const SpellEquipVetArtifacts = require('app/sdk/spells/spellEquipVetArtifacts');
...
const ModifierTakesDoubleDamage = require('app/sdk/modifiers/modifierTakesDoubleDamage');
const ModifierOpeningGambitChangeSignatureCard = require('app/sdk/modifiers/modifierOpeningGambitChangeSignatureCard');
...
const ModifierToggleStructure = require('app/sdk/modifiers/modifierToggleStructure');
...
class CardFactory_BloodstormSet_Faction3 {
  ...
  static cardForIdentifier(identifier,gameSession) {
    ...
    if (identifier === Cards.Faction3.GrandmasterNoshRak) {
      ...
      const customContextObject = ModifierTakesDoubleDamage.createContextObjectOnBoard();
    ...
    if (identifier === Cards.Spell.StoneToSpears) {
      ...
      const attackBuffContextObject = Modifier.createContextObjectWithAttributeBuffs(3);
      ...
      const toggleStructureContextObject =  ModifierToggleStructure.createContextObject();
