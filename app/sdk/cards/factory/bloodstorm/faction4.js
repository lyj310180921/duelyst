...
const SpellLifeDrain = require('app/sdk/spells/spellLifeDrain');
const SpellFollowupHeal = require('app/sdk/spells/spellFollowupHeal');
const SpellWraithstorm = require('app/sdk/spells/spellWraithstorm');
const SpellSpawnEntityOnShadowCreep = require('app/sdk/spells/spellSpawnEntityOnShadowCreep');
const SpellFuriousLings = require('app/sdk/spells/spellFuriousLings');
const SpellKillDamagedMinion = require('app/sdk/spells/spellKillDamagedMinion');
const SpellSummonHusks = require('app/sdk/spells/spellSummonHusks');

const Modifier = require('app/sdk/modifiers/modifier');
const ModifierCardControlledPlayerModifiers = require('app/sdk/modifiers/modifierCardControlledPlayerModifiers');
const ModifierAttacksDealNoDamage = require('app/sdk/modifiers/modifierAttacksDealNoDamage');
const ModifierStackingShadows = require('app/sdk/modifiers/modifierStackingShadows');
const ModifierOpeningGambitGrandmasterVariax = require('app/sdk/modifiers/modifierOpeningGambitGrandmasterVariax');
const ModifierSynergizeApplyModifiersToWraithlings = require('app/sdk/modifiers/modifierSynergizeApplyModifiersToWraithlings');
const ModifierDyingWishTransformRandomMinion = require('app/sdk/modifiers/modifierDyingWishTransformRandomMinion');
