...
const ModifierSynergizeSpawnVanarToken = require('app/sdk/modifiers/modifierSynergizeSpawnVanarToken');
const ModifierKillWatchRefreshExhaustion = require('app/sdk/modifiers/modifierKillWatchRefreshExhaustion');
const ModifierDealDamageWatchRefreshSignatureCard = require('app/sdk/modifiers/modifierDealDamageWatchRefreshSignatureCard');
...
const ModifierOpeningGambitSpawnVanarTokensAroundGeneral = require('app/sdk/modifiers/modifierOpeningGambitSpawnVanarTokensAroundGeneral');
...
class CardFactory_BloodstormSet_Faction6 {
  ...
  static cardForIdentifier(identifier,gameSession) {
    ...
    if (identifier === Cards.Spell.Enfeeble) {
      ...
      const customContextObject = Modifier.createContextObjectWithAttributeBuffs(1,1);
