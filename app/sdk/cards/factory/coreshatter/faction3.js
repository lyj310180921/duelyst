...
const SpellIntensifySpawnEntitiesNearGeneral = require('app/sdk/spells/spellIntensifySpawnEntitiesNearGeneral');
const SpellApplyModifiers = require('app/sdk/spells/spellApplyModifiers');
const SpellSummoningStones = require('app/sdk/spells/spellSummoningStones');
const SpellDrawArtifact = require('app/sdk/spells/spellDrawArtifact');
const SpellThoughtExchange = require('app/sdk/spells/spellThoughtExchange');
const SpellMetalworking = require('app/sdk/spells/spellMetalworking');

const Modifier = require('app/sdk/modifiers/modifier');
const ModifierOpeningGambit = require('app/sdk/modifiers/modifierOpeningGambit');
const ModifierStartOpponentsTurnWatchRemoveEntity = require('app/sdk/modifiers/modifierStartOpponentsTurnWatchRemoveEntity');
const ModifierEnemyCannotCastBBS = require('app/sdk/modifiers/modifierEnemyCannotCastBBS');
const ModifierStartTurnWatchRestoreChargeToArtifacts = require('app/sdk/modifiers/modifierStartTurnWatchRestoreChargeToArtifacts');
const ModifierIntensifyBuffSelf = require('app/sdk/modifiers/modifierIntensifyBuffSelf');
const ModifierIntensifyDamageEnemyGeneral = require('app/sdk/modifiers/modifierIntensifyDamageEnemyGeneral');
...
const ModifierMyAttackWatchScarabBlast = require('app/sdk/modifiers/modifierMyAttackWatchScarabBlast');
const ModifierEquipFriendlyArtifactWatchGainAttackEqualToCost = require('app/sdk/modifiers/modifierEquipFriendlyArtifactWatchGainAttackEqualToCost');
const ModifierOnSummonFromHandApplyEmblems = require('app/sdk/modifiers/modifierOnSummonFromHandApplyEmblems');
const ModifierDyingWishGoldenGuide = require('app/sdk/modifiers/modifierDyingWishGoldenGuide');
...
const ModifierFateVetruvianMovementQuest = require('app/sdk/modifiers/modifierFateVetruvianMovementQuest');
