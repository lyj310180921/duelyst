...
const SpellHealYourGeneral = require('app/sdk/spells/spellHealYourGeneral');

const Modifier = require('app/sdk/modifiers/modifier');
const ModifierEnemySpellWatchHealMyGeneral = require('app/sdk/modifiers/modifierEnemySpellWatchHealMyGeneral');
const ModifierFirstBlood = require('app/sdk/modifiers/modifierFirstBlood');
const ModifierReplaceWatchApplyModifiersToReplaced = require('app/sdk/modifiers/modifierReplaceWatchApplyModifiersToReplaced');
const ModifierManaCostChange = require('app/sdk/modifiers/modifierManaCostChange');
const ModifierDyingWishDamageGeneral = require('app/sdk/modifiers/modifierDyingWishDamageGeneral');
...
const ModifierIntensifyDamageNearby = require('app/sdk/modifiers/modifierIntensifyDamageNearby');
const ModifierReplaceWatchShuffleCardIntoDeck = require('app/sdk/modifiers/modifierReplaceWatchShuffleCardIntoDeck');
const ModifierEndTurnWatchAnyPlayerPullRandomUnits = require('app/sdk/modifiers/modifierEndTurnWatchAnyPlayerPullRandomUnits');
const ModifierOpponentSummonWatchSummonMinionInFront = require('app/sdk/modifiers/modifierOpponentSummonWatchSummonMinionInFront');
const ModifierProvoke = require('app/sdk/modifiers/modifierProvoke');
const ModifierEndTurnWatchGainLastSpellPlayedThisTurn = require('app/sdk/modifiers/modifierEndTurnWatchGainLastSpellPlayedThisTurn');
const ModifierOnSummonFromHandApplyEmblems = require('app/sdk/modifiers/modifierOnSummonFromHandApplyEmblems');
const ModifierSummonWatchBurnOpponentCards = require('app/sdk/modifiers/modifierSummonWatchBurnOpponentCards');
const ModifierKillWatchAndSurviveScarzig = require('app/sdk/modifiers/modifierKillWatchAndSurviveScarzig');
const ModifierForcefield = require('app/sdk/modifiers/modifierForcefield');
const ModifierFateSingleton = require('app/sdk/modifiers/modifierFateSingleton');
...
const ModifierMyAttackWatchApplyModifiersToAllies = require('app/sdk/modifiers/modifierMyAttackWatchApplyModifiersToAllies');
const ModifierOpeningGambit = require('app/sdk/modifiers/modifierOpeningGambit');
const ModifierOpeningGambitTransformHandIntoLegendaries = require('app/sdk/modifiers/modifierOpeningGambitTransformHandIntoLegendaries');
const ModifierEndTurnWatchAnyPlayerHsuku = require('app/sdk/modifiers/modifierEndTurnWatchAnyPlayerHsuku');
