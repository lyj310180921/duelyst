...
const SpellSpawnEntitiesOnEdgeSpaces = require('app/sdk/spells/spellSpawnEntitiesOnEdgeSpaces');
const SpellApplyModifiersToExhaustedMinion = require('app/sdk/spells/spellApplyModifiersToExhaustedMinion');
const SpellApplyModifiers = require('app/sdk/spells/spellApplyModifiers');
const SpellIntensifyTeleportOwnSide = require('app/sdk/spells/spellIntensifyTeleportOwnSide');
const SpellInfiniteHowlers = require('app/sdk/spells/spellInfiniteHowlers');
const SpellTransformSameManaCost = require('app/sdk/spells/spellTransformSameManaCost');
const SpellCreepingFrost = require('app/sdk/spells/spellCreepingFrost');
...
const ModifierEntersBattlefieldWatchApplyModifiers = require('app/sdk/modifiers/modifierEntersBattlefieldWatchApplyModifiers');
const ModifierOpeningGambitDestroyManaCrystal = require('app/sdk/modifiers/modifierOpeningGambitDestroyManaCrystal');
const ModifierOpeningGambitBonusManaCrystal = require('app/sdk/modifiers/modifierOpeningGambitBonusManaCrystal');
const ModifierDyingWishDestroyManaCrystal = require('app/sdk/modifiers/modifierDyingWishDestroyManaCrystal');
...
const ModifierEnemyStunWatch = require('app/sdk/modifiers/modifierEnemyStunWatch');
const ModifierEnemyStunWatchTransformThis = require('app/sdk/modifiers/modifierEnemyStunWatchTransformThis');
const ModifierEnemyStunWatchDamageNearbyEnemies = require('app/sdk/modifiers/modifierEnemyStunWatchDamageNearbyEnemies');
const ModifierIntensifySpawnEntitiesNearby = require('app/sdk/modifiers/modifierIntensifySpawnEntitiesNearby');
const ModifierKillWatchRefreshExhaustionIfTargetStunned = require('app/sdk/modifiers/modifierKillWatchRefreshExhaustionIfTargetStunned');
const ModifierEnemyStunWatchFullyHeal = require('app/sdk/modifiers/modifierEnemyStunWatchFullyHeal');
const ModifierOnSummonFromHandApplyEmblems = require('app/sdk/modifiers/modifierOnSummonFromHandApplyEmblems');
const ModifierOpeningGambitChangeSignatureCardForThisTurn = require('app/sdk/modifiers/modifierOpeningGambitChangeSignatureCardForThisTurn');
const ModifierOpeningGambitRefreshSignatureCard = require('app/sdk/modifiers/modifierOpeningGambitRefreshSignatureCard');
...
const ModifierFateVanarTokenQuest = require('app/sdk/modifiers/modifierFateVanarTokenQuest');
