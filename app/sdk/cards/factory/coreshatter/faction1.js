...
const SpellIntensifyIncreasingDominance = require('app/sdk/spells/spellIntensifyIncreasingDominance');
const SpellBuffAttributeByOtherAttribute = require('app/sdk/spells/spellBuffAttributeByOtherAttribute');
const SpellResilience = require('app/sdk/spells/spellResilience');
const SpellRally = require('app/sdk/spells/spellRally');
const SpellChargeIntoBattle = require('app/sdk/spells/spellChargeIntoBattle');
const SpellOnceMoreWithProvoke = require('app/sdk/spells/spellOnceMoreWithProvoke');

const Modifier = require('app/sdk/modifiers/modifier');
const ModifierBandingFlying = require('app/sdk/modifiers/modifierBandingFlying');
const ModifierProvoke = require('app/sdk/modifiers/modifierProvoke');
const ModifierIntensifyOneManArmy = require('app/sdk/modifiers/modifierIntensifyOneManArmy');
const ModifierFriendsguard = require('app/sdk/modifiers/modifierFriendsguard');
const ModifierMyGeneralAttackWatchSpawnRandomEntityFromDeck = require('app/sdk/modifiers/modifierMyGeneralAttackWatchSpawnRandomEntityFromDeck');
...
const ModifierStartTurnWatchImmolateDamagedMinions = require('app/sdk/modifiers/modifierStartTurnWatchImmolateDamagedMinions');
...
const ModifierFateLyonarSmallMinionQuest = require('app/sdk/modifiers/modifierFateLyonarSmallMinionQuest');
