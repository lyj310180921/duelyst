...
const SpellAstralFlood = require('app/sdk/spells/spellAstralFlood');
const SpellWhisperOfTheSands = require('app/sdk/spells/spellWhisperOfTheSands');
const SpellPsychicConduit = require('app/sdk/spells/spellPsychicConduit');
const SpellCircleOfDesiccation = require('app/sdk/spells/spellCircleOfDesiccation');
const SpellCorpseCombustion = require('app/sdk/spells/spellCorpseCombustion');
...
let ModifierOpeningGambitApplyModifiersRandomly = require('app/sdk/modifiers/modifierOpeningGambitApplyModifiersRandomly');
let ModifierImmuneToSpellDamage = require('app/sdk/modifiers/modifierImmuneToSpellDamage');
let ModifierSummonWatchFromActionBarByOpeningGambitBuffSelf = require('app/sdk/modifiers/modifierSummonWatchFromActionBarByOpeningGambitBuffSelf');
...
const ModifierOpeningGambitApplyModifiersToHand = require('app/sdk/modifiers/modifierOpeningGambitApplyModifiersToHand');
...
class CardFactory_ShimzarSet_Faction3 {
  ...
  static cardForIdentifier(identifier,gameSession) {
    ...
    if (identifier === Cards.Faction3.Falcius) {
      ...
      const buffContextObject = Modifier.createContextObjectWithAttributeBuffs(2,0);
