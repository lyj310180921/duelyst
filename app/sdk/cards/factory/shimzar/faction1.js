...
const SpellSkyBurial = require('app/sdk/spells/spellSkyBurial');
const SpellFightingSpirit = require('app/sdk/spells/spellFightingSpirit');
const SpellLucentBeam = require('app/sdk/spells/spellLucentBeam');
const SpellAfterblaze = require('app/sdk/spells/spellAfterblaze');
...
class CardFactory_ShimzarSet_Faction1 {
  ...
  static cardForIdentifier(identifier,gameSession) {
    ...
    if (identifier === Cards.Faction1.RadiantDragoon) {
      ...
      card.manaCost = 3;
      card.rarityId = Rarity.Rare;
      const statContextObject = Modifier.createContextObjectWithAttributeBuffs(0,1);
