...
const SpellCrimsonCoil = require('app/sdk/spells/spellCrimsonCoil');
const SpellShadowWaltz = require('app/sdk/spells/spellShadowWaltz');
const SpellMirrorMeld = require('app/sdk/spells/spellMirrorMeld');
const SpellKoanOfHorns = require('app/sdk/spells/spellKoanOfHorns');
...
class CardFactory_ShimzarSet_Faction2 {
  ...
  static cardForIdentifier(identifier,gameSession) {
    ...
    if (identifier === Cards.Faction2.KiBeholder) {
      ...
      const statContextObject = ModifierCannotMove.createContextObject();
    ...
    if (identifier === Cards.Spell.ShadowWaltz) {
      ...
      const attackBuff = Modifier.createContextObjectWithAttributeBuffs(1,1);
      attackBuff.appliedName = i18next.t("modifiers.faction_2_spell_shadow_waltz_1");
      const manaCostReduction = ModifierManaCostChange.createContextObject(-1);
