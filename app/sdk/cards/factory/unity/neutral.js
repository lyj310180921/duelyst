...
const ModifierOpeningGambitGoleminate = require('app/sdk/modifiers/modifierOpeningGambitGoleminate');
const ModifierSpellWatchDrawRandomArcanyst = require('app/sdk/modifiers/modifierSpellWatchDrawRandomArcanyst');
const ModifierOpeningGambitSpawnTribal = require('app/sdk/modifiers/modifierOpeningGambitSpawnTribal');
const ModifierDyingWishSpawnTribal = require('app/sdk/modifiers/modifierDyingWishSpawnTribal');
const ModifierDrawCardWatchCopySpell = require('app/sdk/modifiers/modifierDrawCardWatchCopySpell');
const ModifierBondPutCardsInHand = require('app/sdk/modifiers/modifierBondPutCardsInHand');
