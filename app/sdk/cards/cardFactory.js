...
const CardFactory_Tutorial = require('./factory/misc/tutorial.coffee');
const CardFactory_Generic = require('./factory/misc/generic.coffee');
const CardFactory_Tiles = require('./factory/misc/tiles.coffee');
const CardFactory_Bosses = require('./factory/misc/bosses.coffee');

const CardFactory_CoreSet_Faction1 = require('./factory/core/faction1.coffee');
const CardFactory_CoreSet_Faction2 = require('./factory/core/faction2.coffee');
const CardFactory_CoreSet_Faction3 = require('./factory/core/faction3.coffee');
const CardFactory_CoreSet_Faction4 = require('./factory/core/faction4.coffee');
const CardFactory_CoreSet_Faction5 = require('./factory/core/faction5.coffee');
const CardFactory_CoreSet_Faction6 = require('./factory/core/faction6.coffee');
const CardFactory_CoreSet_Neutral = require('./factory/core/neutral.coffee');

const CardFactory_Monthly_Sisters = require('./factory/monthly/sisters.coffee');
const CardFactory_Monthly_M1_Movement = require('./factory/monthly/m1_movement.coffee');
const CardFactory_Monthly_M2_Reactive = require('./factory/monthly/m2_reactive.coffee');
const CardFactory_Monthly_M3_OpeningGambitBuff = require('./factory/monthly/m3_opening_gambit_buff.coffee');
const CardFactory_Monthly_M4_Replace = require('./factory/monthly/m4_replace.coffee');
const CardFactory_Monthly_M5_Provoke = require('./factory/monthly/m5_provoke.coffee');
const CardFactory_Monthly_M6_Forcefield = require('./factory/monthly/m6_forcefield.coffee');
const CardFactory_Monthly_M7_Warmasters = require('./factory/monthly/m7_warmasters.coffee');
const CardFactory_Monthly_M8_Rexx = require('./factory/monthly/m8_rexx.coffee');
const CardFactory_Monthly_M9_Streamers = require('./factory/monthly/m9_streamers.coffee');
const CardFactory_Monthly_M10_GeneralDamage = require('./factory/monthly/m10_general_damage.coffee');
const CardFactory_Monthly_M11_PennyArcade = require('./factory/monthly/m11_penny_arcade.coffee');
const CardFactory_Monthly_M12_OctoberMonthlies = require('./factory/monthly/m12_october_monthlies.coffee');
const CardFactory_Monthly_M13_NovemberMonthlies = require('./factory/monthly/m13_november_monthlies.coffee');

const CardFactory_ShimzarSet_Faction1 = require('./factory/shimzar/faction1.coffee');
const CardFactory_ShimzarSet_Faction2 = require('./factory/shimzar/faction2.coffee');
const CardFactory_ShimzarSet_Faction3 = require('./factory/shimzar/faction3.coffee');
const CardFactory_ShimzarSet_Faction4 = require('./factory/shimzar/faction4.coffee');
const CardFactory_ShimzarSet_Faction5 = require('./factory/shimzar/faction5.coffee');
const CardFactory_ShimzarSet_Faction6 = require('./factory/shimzar/faction6.coffee');
const CardFactory_ShimzarSet_Neutral = require('./factory/shimzar/neutral.coffee');

const CardFactory_BloodstormSet_Faction1 = require('./factory/bloodstorm/faction1.coffee');
const CardFactory_BloodstormSet_Faction2 = require('./factory/bloodstorm/faction2.coffee');
const CardFactory_BloodstormSet_Faction3 = require('./factory/bloodstorm/faction3.coffee');
const CardFactory_BloodstormSet_Faction4 = require('./factory/bloodstorm/faction4.coffee');
const CardFactory_BloodstormSet_Faction5 = require('./factory/bloodstorm/faction5.coffee');
const CardFactory_BloodstormSet_Faction6 = require('./factory/bloodstorm/faction6.coffee');
const CardFactory_BloodstormSet_Neutral = require('./factory/bloodstorm/neutral.coffee');

const CardFactory_UnitySet_Faction1 = require('./factory/unity/faction1.coffee');
const CardFactory_UnitySet_Faction2 = require('./factory/unity/faction2.coffee');
const CardFactory_UnitySet_Faction3 = require('./factory/unity/faction3.coffee');
const CardFactory_UnitySet_Faction4 = require('./factory/unity/faction4.coffee');
const CardFactory_UnitySet_Faction5 = require('./factory/unity/faction5.coffee');
const CardFactory_UnitySet_Faction6 = require('./factory/unity/faction6.coffee');
const CardFactory_UnitySet_Neutral = require('./factory/unity/neutral.coffee');

const CardFactory_Gauntlet_Specials = require('./factory/misc/gauntlet_specials.coffee');

const CardFactory_FirstWatchSet_Faction1 = require('./factory/firstwatch/faction1.coffee');
const CardFactory_FirstWatchSet_Faction2 = require('./factory/firstwatch/faction2.coffee');
const CardFactory_FirstWatchSet_Faction3 = require('./factory/firstwatch/faction3.coffee');
const CardFactory_FirstWatchSet_Faction4 = require('./factory/firstwatch/faction4.coffee');
const CardFactory_FirstWatchSet_Faction5 = require('./factory/firstwatch/faction5.coffee');
const CardFactory_FirstWatchSet_Faction6 = require('./factory/firstwatch/faction6.coffee');
const CardFactory_FirstWatchSet_Neutral = require('./factory/firstwatch/neutral.coffee');

const CardFactory_WartechSet_Faction1 = require('./factory/wartech/faction1.coffee');
const CardFactory_WartechSet_Faction2 = require('./factory/wartech/faction2.coffee');
const CardFactory_WartechSet_Faction3 = require('./factory/wartech/faction3.coffee');
const CardFactory_WartechSet_Faction4 = require('./factory/wartech/faction4.coffee');
const CardFactory_WartechSet_Faction5 = require('./factory/wartech/faction5.coffee');
const CardFactory_WartechSet_Faction6 = require('./factory/wartech/faction6.coffee');
const CardFactory_WartechSet_Neutral = require('./factory/wartech/neutral.coffee');

const CardFactory_CoreshatterSet_Faction1 = require('./factory/coreshatter/faction1.coffee');
const CardFactory_CoreshatterSet_Faction2 = require('./factory/coreshatter/faction2.coffee');
const CardFactory_CoreshatterSet_Faction3 = require('./factory/coreshatter/faction3.coffee');
const CardFactory_CoreshatterSet_Faction4 = require('./factory/coreshatter/faction4.coffee');
const CardFactory_CoreshatterSet_Faction5 = require('./factory/coreshatter/faction5.coffee');
const CardFactory_CoreshatterSet_Faction6 = require('./factory/coreshatter/faction6.coffee');
const CardFactory_CoreshatterSet_Neutral = require('./factory/coreshatter/neutral.coffee');
