...
const get_conversation_partners_of_userid = function(userId) {
  ...
  .then(function(fbRootRef) {
    ...
    return new Promise((resolve, reject) => conversationsRef.orderByKey().limitToLast(1).once("child_added",function(snapshot) {
    ...
    return new Promise(function(resolve, reject) {
      let conversationOn;
      return conversationOn = conversationsRef.orderByKey().on("child_added",function(snapshot) {
