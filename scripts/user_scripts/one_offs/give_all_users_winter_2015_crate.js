...
var _processNextSetOfUsers = function(numProcessed) {
  ...
  .then(function(users) {
    ...
    return Promise.map(users, function(userData) {
      ...
      var txPromise = knex.transaction(function(tx){
        ...
        .spread(function(userGiftCrates,userOpenedGiftCrates){
    ...
    ,4);}).then(function(needsMoreProcessing) {
