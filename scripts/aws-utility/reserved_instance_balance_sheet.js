...
Promise.all([
  ...
  for (var reservedInstance of Array.from(reservedInstancesReduced)) {
    for (var reservation of Array.from(instances["Reservations"])) {
      for (var instance of Array.from(reservation["Instances"])) {
