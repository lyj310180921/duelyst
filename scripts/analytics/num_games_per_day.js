...
//      usersRef = fbRootRef.child("games-data").child("alpha")
      ...
      return gamesRef.orderByChild("createdAt").limitToLast(1).on("child_added", function(snapshot) {
    ...
    return new Promise( (resolve, reject) => gamesRef.orderByChild("createdAt").startAt(oldestDayToRetrieve.valueOf()).endAt(moment().valueOf()).on("child_added", function(snapshot) {
