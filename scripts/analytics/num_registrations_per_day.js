...
const num_registrations_per_day = function(numDaysToLookBack) {
  ...
  .then(function(fbRootRef) {
    ...
    return new Promise( (resolve, reject) => usersRef.orderByChild("createdAt").startAt(oldestDayToRetrieve.valueOf()).endAt(moment().valueOf()).on("child_added", function(snapshot) {
