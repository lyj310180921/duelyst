...
module.exports = function(job, done) {
  ...
  .then(function(gameServer) {
    ...
    return createGameAsync(gameType, token1, token2, gameServer);}).then(function(gameId) {
    ...
    return done(null, {gameId});}).catch(error => // Note we are leaking a 'unsanitized' error message here
